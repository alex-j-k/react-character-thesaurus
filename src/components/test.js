...
//   { char:'载',  pinyin: 'zai4 <br>(zai3)', meaning:'To Load <br>(Write Down)',    rad: [[...土],[...车],[...戈]]},
  
//   { char: '彻', pinyin: 'che4',             meaning: 'Thorough',                           rad:[  [...彳],[...七],[...刀]  ]},
//   { char: '切', pinyin: 'qie1<br> (qie4)',  meaning:   'Cut<br> (Eager)',                   rad:[ [...七],[...刀]  ]},
    ...
    {listOfCharacterInfo.char == clickedCharacter ? "mainCharacterCardClicked" : "mainCharacterCard"}
        ...
        id={listOfCharacterInfo.char}>
            ...
            <div className="listOfSimilarCharacters">{eachArray}</div>
                  ...
                  eachArray.map(eachIndividualSimilarCharacter =>
